...
@push('styles')
    ...
    <style>
        ...
        .hero-slide::after {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(135deg, rgb(0 30 15 / 0%), rgb(0 108 53 / 0%));
        }
        ...
        .fs-off:hover {
            ...
            background: linear-gradient(135deg, #00a65178 0%, #00a65169 100%) !important;
        ...
        .fs-off-name {
            font-size: clamp(15px, 1.9vw, 1rem);
            font-weight: 800;
        ...
        .section-title__title {
            ...
            text-shadow: -1px 2px 0px rgb(16 16 16 / 90%);
        }
        ...
        .ao-card-nm {
            ...
            color: #ffffff !important;
            text-shadow: 0px 2px 0px rgb(0 0 0), 0px 3px 0px rgb(0 0 0) !important;
        ...
        @media(max-width:992px) {
            ...
            .ao-card {
                flex: 0 1 calc((100% - 30px) / 4) !important;
                min-height: 90px;
                min-width: 8rem;
                max-width: 100% !important;
                width: 100% !important;
...
@section('content')
    ...
    <section class="hero">
        ...
        <div class="hero-slider" id="heroSlider">
            ...
            @empty
                <div class="hero-slide active" style="background-image:url('{{ asset('images/slide-riyadh-business.jpg') }}')">
                </div>
        ...
        <div class="about-one-wrap">
            ...
            <div class="about-one__right">
                <a href="{{ route('amrtm.create-contract') }}" class="ao-floating-contract" data-create-contract>
            ...
            <div class="about-one__left">
                <div class="about-one__img-box">
                    ...
                    <div class="about-one__img" onclick="openVid()"
                        ...
                        <img src="{{ asset($homepageSettings['video_poster'] ?? 'images/logo2.jpg') }}" alt="منصة أمر تم"
                            loading="lazy"
                ...
                <div class="about-one__cards-grid">
                    ...
                    @forelse($categories as $cat)
                        @php
                            ...
                            $catWordCount = count(array_values(array_filter(preg_split('/\s+/', trim($cat['name_ar'] ?? '')))));
                        @endphp
                        <a href="{{ route('amrtm.catalog.category', $catKey) }}"
                            class="ao-card {{ $catWordCount === 2 ? 'ao-card--sm' : '' }}" style="--cc:{{ $catColor }}">
                    ...
                    @empty
                        <a href="{{ route('amrtm.catalog.category', 'ministries') }}" class="ao-card" style="--cc:#3B82F6">
                            <div class="ao-card-body">
                                <div class="ao-card-nm">الــــــوزارات</div>
                        ...
                        <a href="{{ route('amrtm.catalog.category', 'companies') }}" class="ao-card ao-card--sm"
                            style="--cc:#22C55E">
                            <div class="ao-card-body">
                        ...
                        <a href="{{ route('amrtm.catalog.category', 'embassies') }}" class="ao-card" style="--cc:#06B6D4">
                            <div class="ao-card-body">
                                <div class="ao-card-nm">السفارات والقنصليات والمنظمات</div>
                    ...
                    <a href="{{ route('amrtm.consultants.directory') }}" class="ao-card" style="--cc:#F97316">
                        <div class="ao-card-body">
        ...
        <!-- ================= OFFICES ================= -->
        <div class="offices-sec" id="offices-sec">
            <div class="offices-inner offices-inner2">
                ...
                <div class="off-cards-grid">
                    ...
                    <a href="{{ route('amrtm.offices.directory', 'law') }}" class="fs-off">
                        <div class="fs-off-icon" style="background:linear-gradient(135deg,#006C35,#00843D)"><i
                                class="fa fa-scale-balanced"></i></div>
                        <div class="fs-off-name">مكاتب المحاماة</div>
                    </a>
                    <a href="{{ route('amrtm.offices.directory', 'services') }}" class="fs-off">
                        <div class="fs-off-icon" style="background:linear-gradient(135deg,#bd15c0,#c71ee5)"><i
                                class="fa fa-briefcase"></i></div>
                        <div class="fs-off-name">مكاتب الخدمات والتعقيب</div>
                    </a>
                    <a href="{{ route('amrtm.offices.directory', 'customs') }}" class="fs-off">
                        <div class="fs-off-icon" style="background:linear-gradient(135deg,#2182f0,#0688eb)"><i
                                class="fa fa-address-book"></i></div>
                        <div class="fs-off-name">شركات التخليص الجمركي</div>
                    </a>
                    <a href="{{ route('amrtm.offices.directory', 'accounting') }}" class="fs-off">
                        <div class="fs-off-icon" style="background:linear-gradient(135deg,#2207a7,#0b05d1)"><i
                                class="fa fa-calculator"></i></div>
                        <div class="fs-off-name">الاستشارات المالية والضريبية</div>
                    </a>
                    <a href="{{ route('amrtm.offices.directory', 'engineering') }}" class="fs-off">
                        <div class="fs-off-icon" style="background:linear-gradient(135deg,#f69d03,#e9a403)"><i
                                class="fa fa-building"></i></div>
                        <div class="fs-off-name">الاستشارات الهندسية</div>
                    </a>
                    <a href="{{ route('amrtm.offices.directory', 'freelance') }}" class="fs-off">
                        <div class="fs-off-icon" style="background:linear-gradient(135deg,#00695C,#00897B)"><i
                                class="fa fa-user"></i></div>
                        <div class="fs-off-name">أصحاب المهن الحرة</div>
                    </a>
                </div>
    ...
    <div class="fm" id="fm" onclick="if(event.target===this)closeFm()">
        <div class="fm-box">
            ...
            <div class="fm-body" id="fm-in">
                ...
                <div class="fm-sec-lbl" style="margin-top:.4rem"><i class="fa fa-building"></i><span id="fm-lbl-biz">بيانات
                        الجهة (اختياري)</span></div>
                <div class="fm-row">
    ...
    <footer class="footer">
        ...
        <div class="f-main">
            ...
            <!-- السوشيال -->
            <div class="f-soc">
                <a class="fsoc" href="https://x.com/amrtmcomsa" target="_blank" rel="noopener noreferrer" aria-label="X">
                    <i class="fa fa-x-twitter"></i>
                </a>

                <a class="fsoc" href="https://www.linkedin.com/in/amrtm-com-sa/" target="_blank" rel="noopener noreferrer"
                    aria-label="LinkedIn">
    ...
    <script>
        ...
        const Auth = {
            ...
            async logout() {
                ...
                const logoutUrl = routes.logout || '/logout';
            ...
            requireAdmin() {
                if (!this.isLoggedIn() || !this.isAdmin()) {
                    window.location.href = (window.AMRTM_ROUTES || {}).login || '/login';
                    return false;
                }
                return true;
            },
        ...
        async function init() {
            ...
            if (Array.isArray(serverCategories) && serverCategories.length > 0) {
                ...
                try {
                    const apiRes = await (typeof API !== 'undefined' ? API.get('/services') : fetch('/api/services').then(r => r.json()));
        ...
        function renderCards(list = cats) {
            ...
            g.innerHTML = list
                ...
                .map((c) => {
                    ...
                    const desc = t[cc.dk] || "";
                    //  const catUrl =
                    //    (window.AMRTM_ROUTES?.catalogBase || "/catalog") +
                    //   "/" +
                    //  c.key;  #MARAM
                    const catUrl = c.url || ((window.AMRTM_ROUTES?.catalogBase || "/catalog") + "/" + c.key);
        ...
        function openFm(idx) {
            ...
            updBal();
            // Labels
            ["ln", "lph", "lem", "lco", "lcr", "lno", "lfi"].forEach((k) =>
                S(k, "textContent", t[k]),
            );
            ...
            ["ent", "epht", "eemt"].forEach((k, i) =>
                S(k, "textContent", [t.erq, t.eph, t.eem][i]),
            );
            // Prefill
